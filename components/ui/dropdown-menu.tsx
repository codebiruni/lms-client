  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          // Added data-[state]:animate-none and data-[state]:opacity-100 to override any hidden animations
          "bg-popover text-popover-foreground z-50 max-h-(--radix-dropdown-menu-content-available-height) min-w-32 overflow-x-hidden overflow-y-auto rounded border p-1 shadow-md data-[state=open]:animate-none data-[state=open]:opacity-100 data-[state=closed]:animate-none",
          className
        )}
        {...props}
      />
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        // REMOVE ALL OF THESE ANIMATION CLASSES:
